...
try:
    try:
    salary_df = pd.read_csv('npb-salary-app/data/salary_2023&2024&2025.csv')
    stats_2023 = pd.read_csv('npb-salary-app/data/stats_2023.csv')
    stats_2024 = pd.read_csv('npb-salary-app/data/stats_2023.csv')
    stats_2025 = pd.read_csv('npb-salary-app/data/stats_2023.csv')
    titles_df = pd.read_csv('npb-salary-app/data/titles_2023&2024&2025.csv')
